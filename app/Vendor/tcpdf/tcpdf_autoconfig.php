...
if (!defined('PDF_CUSTOM_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'custom_logo.png')) {
		$tcpdf_header_logo = 'custom_logo.npg';
	}
	define ('PDF_CUSTOM_HEADER_LOGO', $tcpdf_header_logo);
}
...
if (!defined('PDF_CUSTOM_HEADER_LOGO_WIDTH')) {
	if (!empty($tcpdf_header_logo)) {
		define ('PDF_CUSTOM_HEADER_LOGO_WIDTH', 30);
	} else {
		define ('PDF_CUSTOM_HEADER_LOGO_WIDTH', 0);
	}
}
