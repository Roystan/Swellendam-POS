 ...
 */
class DependantrolesController extends MembersAppController {
 ...
 * @access public
 */
	public $uses = array('Members.Dependantrole');
 ...
 */
	public function admin_index() {
		...
		$this->paginate['Dependantrole']['order'] = "Dependantrole.id ASC";
		$this->set('dependantroles', $this->paginate());
 ...
 */
	public function admin_add() {
		...
		if (!empty($this->request->data)) {
			$this->Dependantrole->create();
			if ($this->Dependantrole->save($this->request->data)) {
 ...
 */
	public function admin_edit($id = null) {
		...
		if (empty($this->request->data)) {
			$this->request->data = $this->Dependantrole->read(null, $id);
		}
	}
